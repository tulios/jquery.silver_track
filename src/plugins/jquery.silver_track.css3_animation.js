...
(function($, window, document) {
  ...
  $.silverTrackPlugin("Css3Animation", {
    ...
    onInstall: function(track) {
      ...
      if (!this.fallback) {
        ...
        this.track.options.animateFunction = function(movement, duration, easing, afterCallback) {
          self._cssAnimate(movement, duration, easing, afterCallback);
        }
      }
    },
    ...
    _cssAnimate: function(movement, duration, easing, afterCallback) {
      var element = this.track.container;
    ...
    _toCompatibleVersion: function(name, value) {
      var output = {};
    ...
    _easingFunctionToCubicBezier: function(easing) {
      return CubicBezierMap[easing] || CubicBezierMap["ease"];
    }
